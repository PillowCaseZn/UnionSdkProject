 ...
 * 注意：
 * 1、如果游戏Application直接继承使用 com.pillowcase.union.UnionApplication
 * 2、如果游戏Application没有继承使用 com.pillowcase.union.UnionApplication。游戏方在接入时，则需要在
 * 在游戏方自身Application内，初始化 UnionSdk , 并且在 onCreate 、 attachBaseContext 、onConfigurationChanged 、onTerminate
 * 调用SDK对应的方法函数
